   ...
   return (
      <div className="flex flex-col mt-20 gap-10 flex-wrap">
         <div className="flex justify-center gap-8 flex-wrap max-w-[70%] mx-auto">
            <img src={icons.facebook} className="w-10" />
            <img src={icons.instagram} className="w-10" />
            <img src={icons.twitter} className="w-10" />
            <img src={icons.snapchat} className="w-10" />
            <img src={icons.tiktok} className="w-10" />
            <img src={icons.tumblr} className="w-10" />
            <img src={icons.youtube} className="w-10" />
         </div>
